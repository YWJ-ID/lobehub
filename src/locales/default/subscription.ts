export default {
  ...
  'credits.recharge.title': 'Credit Recharge',
  'credits.recharge.balance': 'Current Balance',
  'credits.recharge.selectPackage': 'Select Recharge Package',
  'credits.recharge.package': 'Package',
  'credits.recharge.credits': 'Credits',
  'credits.recharge.price': 'Price',
  'credits.recharge.action': 'Recharge',
  'credits.recharge.loading': 'Loading...',
  'credits.recharge.error': 'Failed to load credit data',
  'credits.recharge.rechargeError': 'Failed to create recharge order',
  'credits.recharge.history': 'Recharge History',
  'credits.recharge.history.empty': 'No recharge history',
  'credits.recharge.history.date': 'Date',
  'credits.recharge.history.amount': 'Amount',
  'credits.recharge.history.balanceAfter': 'Balance After',
  'credits.recharge.history.type.recharge': 'Recharge',
  'credits.recharge.history.type.usage': 'Usage',
  'credits.recharge.history.type.adjustment': 'Adjustment',
  'credits.recharge.confirmTitle': 'Confirm Recharge',
  'credits.recharge.confirmMessage': 'Recharge {{credits}} credits for ¥{{price}}?',
  'credits.recharge.confirmButton': 'Confirm',
  'credits.recharge.cancelButton': 'Cancel',
  'credits.recharge.redirecting': 'Redirecting to Alipay...',
